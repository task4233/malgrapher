...
def get_node_embedings(G: Union[MultiDiGraph, MultiGraph], dims: int = 64, walk_length: int = 30, num_walks: int = 200, workers: int = 4, window_size: int = 10, min_count: int = 1, batch_words: int = 4, debug: bool = False) -> KeyedVectors:
    if G is None:
